...
While not required for the app to function, if you want to use it for the intended purpose, you need need a virtual microphone device to send the audio to, like **VB-Audio Cable** or the virtual output of **Voicemeeter**.

The app uses the text to speech voices installed on your system.
