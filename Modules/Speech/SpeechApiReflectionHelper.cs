...
public static class SpeechApiReflectionHelper {
	...
	/// <summary>
	/// Injects missing voices back into speech synthesizer via reflection.
	/// </summary>
	/// <param name="synthesizer">Synthesizer to ineject voices into.</param>
	...
	public static void InjectOneCoreVoices(this SpeechSynthesizer synthesizer) {
		...
		using (otc) {
			...
			foreach (var token in tokens) {
				...
				var voiceInfo = typeof(SpeechSynthesizer)
					.Assembly
					.CreateInstance(
				...
				var installedVoice = typeof(SpeechSynthesizer)
					.Assembly
					.CreateInstance(
